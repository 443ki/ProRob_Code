...
class Camera(IdealCamera):
    def __init__(self, env_map,
        ...
        self.direction_bias_std = norm.rvs(scale=direction_bias_stddev)
    ...
    def bias(self, relpos):
        return relpos + np.array([relpos[0]*self.distance_bias_rate_std, self.direction_bias_std]).T
...
if __name__ == '__main__':
    ...
    r = Robot( np.array([0, 0, 0]).T, sensor=Camera(m, occlusion_prob=0.1), agent=circling)
    world.append(r)
